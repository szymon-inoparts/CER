    ...
    <div class="claim-card claim-card--split">
      <div class="claim-card__panel claim-card__panel--main">
        ...
        <div class="claim-card__timeline">
          <div><span>Data przyjêcia</span><strong>${formatDate(claim.receivedAt)}</strong></div>
        ...
        <div class="claim-card__grid">
          <div><div class="label">Powód zg³oszenia</div><div class="value">${claim.reason || "-"}</div></div>
